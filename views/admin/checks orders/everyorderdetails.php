...
<?php 
    $id=$_GET['id'];
    $stmt=$con->prepare("SELECT image , name ,price, quantity FROM Order_Product,Product 
    ...
    <img  class="card-img-top pt-3" width="150px" height="200px" src="<?php echo $order['image']?>" >
   <div class="card-body">
